(function () {
    ...
    function update(info) {
        ...
        Array.from(document.querySelectorAll("[color]")).map(ele => {
            var c = ele.attributes.color.value.toLowerCase();

            var type = ele.attributes.shade != null ? ele.attributes.shade.value : "500";
